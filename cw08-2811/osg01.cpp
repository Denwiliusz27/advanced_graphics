...
osg::Node * stworz_scene()
{
    ...
    // sfera (0,0,0)
    drw = new osg::ShapeDrawable();
    drw->setShape(new osg::Sphere(osg::Vec3(0.0, 0.0, 0.0), 2.0));
    drw->setColor(osg::Vec4(1.0, 1.0, 1.0, 1.0));
    geom_node->addDrawable(drw);

    // sfera (5,0,0)
    drw = new osg::ShapeDrawable();
    drw->setShape(new osg::Sphere(osg::Vec3(5.0, 0.0, 0.0), 2.0));
    drw->setColor(osg::Vec4(1.0, 0.0, 0.0, 1.0));
    geom_node->addDrawable(drw);

    // sfera (0,5,0)
    drw = new osg::ShapeDrawable();
    drw->setShape(new osg::Sphere(osg::Vec3(0.0, 5.0, 0.0), 2.0));
    drw->setColor(osg::Vec4(0.0, 1.0, 0.0, 1.0));
    geom_node->addDrawable(drw);

    // sfera (0,0,5)
    drw = new osg::ShapeDrawable();
    drw->setShape(new osg::Sphere(osg::Vec3(0.0, 0.0, 5.0), 2.0));
