...
void rysuj(uj_image * image)
{
    ...
    uj_image_fill_rectangle(image, 0, 0, w-1, h-1, bialy);
    uj_image_fill_rectangle(image, w/2, 0, w-1, h/2-1, pomaranczowy);
    uj_image_fill_rectangle(image, 0, h/2, w/2-1, h+10, morski);

//    uj_image_fill_rectangle(image, -10, -20, 20, 20, morski);
//    uj_image_fill_rectangle(image, 60, -40, 80, 30, morski);
//    uj_image_fill_rectangle(image, 300, -40, w+23, 40, morski);
//    uj_image_fill_rectangle(image, 300, 70, w+33, 130, morski);
//    uj_image_fill_rectangle(image, 300, h-20, w+55, h+10, morski);
//    uj_image_fill_rectangle(image, 60, h-40, 80, h+10, morski);
//    uj_image_fill_rectangle(image, -10, h-40, 50, h+30, morski);
//    uj_image_fill_rectangle(image, -10, 80, 50, 90, morski);
}
...
int main(void)
{
    ...
    uj_image_save_file(img, "wynik2.ppm");
